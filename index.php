            ...
            <div class="col-md-12"> <br>
                ...
                <table id="PatientTable" class="display table table-striped  table-hover table-responsive table-bordered ">
                    ...
                    <tbody>
                        <?php
                        require 'connect.php';
                        $sql = 'SELECT patient.Pid,Qdate,QNumber,Pname,genderDescription,Image,QStatus FROM gender,patient,queue
                        WHERE gender.genderID = patient.Pgender AND patient.Pid = queue.Pid';
                        ...
                        foreach ($result as $r) { ?>
                            <tr>
                                ...
                                <td><img src="picture/<?php echo $r['Image']?>" width="50px" height="50" alt="image" onclick="enlargeImg()" id="img1"></td>
                                <td>
                                    <?= $r['QStatus'] ?>
                                </td>
